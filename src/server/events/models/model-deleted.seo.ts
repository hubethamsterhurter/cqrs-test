...
export class ModelDeletedSeo<M extends Model = Model> implements EventType<SERVER_EVENT_TYPE['MODEL_DELETED'], Payload<M>> {
  static get _t() { return _t; }
  @Equals(_t) readonly _t = ModelDeletedSeo._t;
