...
export class ServerEventSocketClientMessageMalformed implements EventType<VER['_0_1'], SERVER_EVET_TYPE['SOCKET_CLIENT_MESSAGE_MALFORMED'], { client: SocketClient, err: Error }> {
