...
interface Payload { socket: SocketClient, code: number, reason: string };

// socket client event
export class ServerEventSocketClientClose implements EventType<VER['_0_1'], SERVER_EVET_TYPE['SOCKET_CLIENT_CLOSE'], Payload> {
