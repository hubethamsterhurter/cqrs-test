...
export class ServerEventSocketClientPing implements EventType<SERVER_EVENT_TYPE['SOCKET_CLIENT_PING'], Payload> {
  static get _t() { return _t; }
  @Equals(_t) readonly _t = ServerEventSocketClientPing._t;
