...
export class SocketClientMessageParsedSeo<M extends ClientMessage = ClientMessage> implements EventType<SERVER_EVENT_TYPE['SOCKET_CLIENT_MESSAGE_PARSED'], Payload<M>> {
  static get _t() { return _t; }
  @Equals(_t) readonly _t = SocketClientMessageParsedSeo._t;
