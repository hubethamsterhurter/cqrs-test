...
export class ServerEventSocketClientMessageInvalid implements EventType<VER['_0_1'], SERVER_EVET_TYPE['SOCKET_CLIENT_MESSAGE_INVALID'], { client: SocketClient, errs: ValidationError[] }> {
  readonly _v = VER._0_1;
  readonly _t = SERVER_EVENT_TYPE.SOCKET_CLIENT_MESSAGE_INVALID;
  constructor(readonly _p: { client: SocketClient, errs: ValidationError[], Ctor: ClassType<ClientMessage> }) {}
}
