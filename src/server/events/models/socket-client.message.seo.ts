...
export class SocketClientMessageSeo implements EventType<SERVER_EVENT_TYPE['SOCKET_CLIENT_MESSAGE'], Payload> {
  static get _t() { return _t; }
  @Equals(_t) readonly _t = SocketClientMessageSeo._t;
