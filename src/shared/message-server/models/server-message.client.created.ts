...
export class ServerMessageClientCreated implements ServerMessageType<VER['_0_1'], SERVER_MESSAGE_TYPE['CLIENT_CREATED']> {
  static get _v() { return _v; }
  static get _t() { return _t; }

  @Equals( _v) readonly _v = ServerMessageClientCreated._v;
